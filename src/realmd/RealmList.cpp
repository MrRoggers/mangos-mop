...
// will only support WoW 1.12.1/1.12.2, WoW:TBC 2.4.3, WoW:WotLK 3.3.5a, WoW:Cataclysm 4.3.4 and official release for WoW:MoP and later, client builds 16357, 15595, 10505, 8606, 6005, 5875
...
{
    {16357, 5, 1, 0, 'a'},                                  // highest supported build, also auto accept all above for simplify future supported builds testing
    {15595, 4, 3, 4, ' '},
	{15050, 4, 3, 0, ' '},
    {13623, 4, 0, 6, 'a'},
    {12340, 3, 3, 5, 'a'},
